...
require (
	...
	local/api v0.0.0-00010101000000-000000000000
...
require (
	...
	local/controller v0.0.0-00010101000000-000000000000 // indirect
	local/middleware v0.0.0-00010101000000-000000000000 // indirect
